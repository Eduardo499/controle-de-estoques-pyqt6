...
class Ui_menu(object):
    ...
    def retranslateUi(self, menu):
        ...
        self.codigo.setText(_translate("menu", "Insira o codigo do produto"))
        self.quantidade.setText(_translate("menu", "Insira a quantidade do produto"))
        self.preco.setText(_translate("menu", "Insira o preço do produto"))
